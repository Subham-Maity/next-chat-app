	...
	return (
		...
		>
			...
			<motion.button
				...
				style={{ position: "absolute", top: "120px", left: "120px", zIndex: "10", animation: showRooms ? "" : "fadeIn 1s infinite alternate" }} // CSS properties for position, size and fadeIn animation
			>
